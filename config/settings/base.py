...
# hyperion_backend/
APPS_DIR = BASE_DIR / "hyperion_backend"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///hyperion_backend",
    ),
}
...
WSGI_APPLICATION = "config.wsgi_handler.application"
...
MIGRATION_MODULES = {"sites": "hyperion_backend.contrib.sites.migrations"}
...
ADMINS = [("""hellno""", "hellno@example.com")]
